    ...
    const frames = [
      ...
      },
      {
        ...
        setup: () => {
          ...
          paddingLayer.style.padding = `${paddingSize}px`;
        }
      },
      {
        name: 'border',
      ...
      },
      {
        ...
        setup: () => {
          ...
          const marginSize = 40;
          marginLayer.style.padding = `${marginSize}px`;
        }
      },
      {
        name: 'dual-boxes-no-margin',
        setup: () => {
          ...
          marginLayerLeft.style.padding = '0';

          // Setup right box (no margin)
      ...
      {
        name: 'dual-boxes-with-margin',
        setup: () => {
          const marginSize = 40;

          // Add margin-right to left box to show spacing
          const marginLayerLeft = document.getElementById('marginLayerLeft');
          marginLayerLeft.classList.add('visible');
          marginLayerLeft.style.padding = `0 ${marginSize}px 0 0`;
        }
      }
    ];
